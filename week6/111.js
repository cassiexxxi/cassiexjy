function bubblePopped(evt){
  ...
  if (evt.propertyName == 'opacity'){
    ...
    hoverObject.removeEventlistener('transitioend', bubblePopped);
  }
}
...
function popBubble(event){
  ...
  if (hoverObject.classList.contains('bubble')){
    ...
    hoverObject.addEventListener('transitioend',bubblePopped)
  }
}
...
function popBubbles(event){
  ...
  bubbles.forEach(function(bubble) {
    ...
    bubble.addEventListener('transitioend', bubblePopped);
  });
}
